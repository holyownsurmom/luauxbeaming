...
function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div
        className="fixed left-0 top-0 bottom-0 z-50 w-[3px] hover:w-[6px] transition-all duration-500 cursor-pointer group/trigger"
      ...
      >
        ...
        >
          ...
          <nav className="flex-1 px-3 space-y-5 overflow-y-auto relative scrollbar-thin">
            {NAV.map((sec, si) => (
              <div
                ...
                style={{
                  transitionDelay: sidebarOpen ? `${si * 50}ms` : "0ms",
                  opacity: sidebarOpen ? 1 : 0,
                  ...
                  {sec.items.map((it, ii) => {
                    ...
                    return (
                      <Link
                        ...
                        style={{
                          transitionDelay: sidebarOpen ? `${(si * 3 + ii) * 30}ms` : "0ms",
                          opacity: sidebarOpen ? 1 : 0,
          ...
          {/* User section */}
          <div
            className="p-3 border-t border-border/40 relative shrink-0 transition-all duration-500"
            style={{
